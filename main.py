"""This is a game module that allows you to train a character."""
...
def attack(char_name: str, char_class: str) -> str:
    """Dealing damage depending on the selected class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Ability to block damage depending on the selected class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """The ability to use a special ability depending on the selected class."""
    if char_class == 'warrior':
